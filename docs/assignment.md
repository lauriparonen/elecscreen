> **Note:** this is the original assignment brief from
> [solita/dev-academy-autumn-2026-exercise](https://github.com/solita/dev-academy-autumn-2026-exercise),
> kept here verbatim. The README at the repo root describes _this_ implementation.
